...
Эта библиотека DLL InProcessLibrary создана автоматически с помощью 
мастера приложений.

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения InProcessLibrary.


InProcessLibrary.vcxproj
...
InProcessLibrary.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем InProcessLibrary.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
